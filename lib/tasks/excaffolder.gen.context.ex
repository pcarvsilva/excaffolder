defmodule Mix.Tasks.Excaffolder.Gen.Context do
  ...
  Generates a context with functions around an Ecto schema.
      ...
      mix excaffolder.gen.context Accounts User users name:string age:integer
  ...
  a `--table` option may be provided. For example:
      ...
      mix excaffolder.gen.context Accounts User users --table cms_users
  ...
  def run(args) do
    if Mix.Project.umbrella? do
      Mix.raise "mix excaffolder.gen.context can only be run inside an application directory"
    end
  ...
  def raise_with_help(msg) do
    ...
    mix excaffolder.gen.html, excaffolder.gen.json and excaffolder.gen.context expect a
    context module name, followed by singular and plural names of
    the generated resource, ending with any number of attributes.
    For example:

        mix excaffolder.gen.html Accounts User users name:string
        mix excaffolder.gen.json Accounts User users name:string
        mix excaffolder.gen.context Accounts User users name:string
